...
S'vivon! is the perfect introduction to the key of F minor for young band students-the note Concert Eis the only accidental, and is used sparingly. With a catchy melody and an engaging blend of syncopation throughout, students will feel an air of festivity while rehearsing S'vivon!. The fun really begins halfway through the music when most everybody gets to be a percussionist - listen for 2 different hand-clap rhythms occurring simultaneously! Especially loved will be the loud shout of "Savi" in the final measure.
