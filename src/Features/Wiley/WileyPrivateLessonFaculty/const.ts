...
export const privateLessonTeacherData: DirectorCardProps[] = [
  ...
  { name: "Suzanne Segredo", instrument: "Oboe", imgSrc: SuzanneSegredo },
  { name: "Joelle Morales", instrument: "Bassoon", imgSrc: JoelleMorales },
  { name: "Kevin Vorabout", instrument: "Clarinet", imgSrc: KevinVorabout },
  { name: "Kelsey Behnfeldt", instrument: "Clarinet", imgSrc: KelseyBehnfeldt },
